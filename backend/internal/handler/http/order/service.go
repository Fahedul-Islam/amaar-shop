...
type Service interface {
	...
	// GetShopOrders retrieves all orders for the authenticated shop owner with pagination.
	GetShopOrders(ctx context.Context, ownerID, page, size string) ([]*domain.Order, error)
