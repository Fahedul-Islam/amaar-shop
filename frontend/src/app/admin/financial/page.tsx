    ...
    <>
      ...
      <PageBody>
        ...
        <div className="bg-teal-50 border border-teal-200 text-teal-900 text-sm rounded-md p-3 mb-4 leading-relaxed">
          ...
          AmaarShop charges each shop using its assigned fee rule — shop owners send this to us every 14 days
          ...
          <>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
              ...
              <MoneyTile
                ...
                hint="Saved fee rates on chargeable orders"
              />
            </div>
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-stone-50 text-stone-500 text-left">
                        ...
                        <th className="px-4 py-2.5 text-[11px] font-medium uppercase tracking-wider text-right">Amount due</th>
      ...
      >
        ...
        <form onSubmit={submit} className="p-5 grid gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-stone-500">
                Owes {formatBDT(shop.outstanding_fee_bdt)} · {formatNumber(shop.unbilled_orders)} chargeable orders
              </div>
            </div>
          </div>
          ...
          <div className="text-xs text-stone-500 bg-stone-50 border border-stone-100 rounded-md p-2.5 leading-relaxed">
            Only the amount recorded is deducted. Any remaining balance stays due. New orders
