  ...
  const advance = async () => {
    ...
    try {
      ...
      setError(
        err instanceof ApiRequestError
          ? err.message
          : "Could not mark advance received",
      );
    }
  };
  ...
  return (
    <div className="px-6 md:px-8 py-6 md:py-7 max-w-5xl">
      ...
      <p className="text-stone-500 mb-5">
        Placed {formatDateTime(order.created_at, locale)} ·{" "}
        {order.customer_name}
      </p>
      ...
      <div className="grid gap-5 md:grid-cols-[minmax(0,1fr)_320px]">
        <Card className="p-5" hover={false}>
          ...
          {order.items.map((it) => (
            <div
              key={it.id}
              className="flex gap-3 pb-3 mb-3 border-b border-stone-100 last:border-0 last:mb-0 last:pb-0"
            >
          ...
          <div className="grid gap-1.5 text-sm text-stone-600 pt-3 border-t border-stone-200">
            ...
            <div className="flex justify-between text-base text-stone-900 font-semibold mt-2">
              <span>Total</span>
    ...
    <Card className="p-5" hover={false}>
      ...
      <div className="flex flex-col gap-2">
        {templates.map((t, i) => (
          <div
            key={i}
            className="border border-stone-200 rounded-md p-2.5 bg-stone-50/40"
          >
      ...
      <p className="text-[10px] text-stone-400 mt-2">
        {locale === "bn"
          ...
          : "WhatsApp usually gets replies fastest."}
      </p>
    </Card>
  );
}
