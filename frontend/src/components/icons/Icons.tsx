...
export const IcLock = ({ size = 20, ...p }: P) => (<svg {...base(size)} {...p}><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>);
...
export const IcUndo = ({ size = 20, ...p }: P) => (<svg {...base(size)} {...p}><path d="M3 7v6h6"/><path d="M21 17a9 9 0 0 0-15-6.7L3 13"/></svg>);
...
export const IcMapPin = ({ size = 20, ...p }: P) => (<svg {...base(size)} {...p}><path d="M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7z"/><circle cx="12" cy="9" r="2.5"/></svg>);
export const IcBanknote = ({ size = 20, ...p }: P) => (<svg {...base(size)} {...p}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>);
export const IcGift = ({ size = 20, ...p }: P) => (<svg {...base(size)} {...p}><polyline points="20 12 20 22 4 22 4 12"/><rect x="2" y="7" width="20" height="5"/><path d="M12 22V7"/><path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z"/><path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/></svg>);
export const IcInfo = ({ size = 20, ...p }: P) => (<svg {...base(size)} {...p}><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>);
