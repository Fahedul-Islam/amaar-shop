import { type CustomerSegment, SEGMENT_LABELS } from '@/lib/customerApi';
...
export function SegmentBadge({ segment, size = 'md' }: { segment: CustomerSegment; size?: 'sm' | 'md' }) {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 rounded-full border font-medium ${sz} ${STYLES[segment]}`}>
